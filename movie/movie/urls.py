...
urlpatterns = [
    ...
    path('register-active-done/', user_views.register_active_done, name='register_active_done'),
    path('register-active-fail/', user_views.register_active_fail, name='register_active_fail'),
